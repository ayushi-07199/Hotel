...
public class GuestUi {
	...
	private void runapp() {
		try {
			Guest guest1 = new Guest("Anuj", 8000);
			Guest guest2 = new Guest("Ayushi", 2000);
			Guest guest3 = new Guest("Ankit", 9000);
			Guest guest4 = new Guest("Luvpreet", 7000);
			service.register(guest1);
			service.register(guest2);
			service.register(guest3);
			service.register(guest4);
			service.updateName(guest1.getId(), "Anuja");
